...
const staticIntro = require('../assets/texts/intro.json');

let myIntro = "Hi, this is an Intro, I am trying to publish "+
				"\nwith GatsbyJs." + staticIntro.intro;
		...
		<section className="wrapper style5">
			<div className="inner">
				...
				<section>
					...
					<h5>Left &amp; Right</h5>
					<p><span className="image left"><img src={pic4} alt="" /></span>{myIntro}</p>
